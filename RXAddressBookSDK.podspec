...
Pod::Spec.new do |s|
  s.name             = 'RXAddressBookSDK'
  s.version          = '1.0.0'
  s.summary          = 'ruixue RXAddressBookSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXAddressBookSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXAddressBookSDK.git', :tag => s.version.to_s }
